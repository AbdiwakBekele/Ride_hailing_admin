...
@section('content')
  <div class="layout-wrapper">
      <div class="main-menu">
        ...
        <div class="page-content">
            ...
            <div class="px-3">
              ...
              <form class="needs-validation" method="POST" action="{{ route('clients.update', $client->id) }}" novalidate>
    @csrf 
    @method('PUT') <!-- Specify the PUT method for updates -->

    <div class="mb-3">
        <label for="validationCustom01" class="form-label">Full Name</label>
        <input type="text" class="form-control" id="validationCustom01" placeholder="Full Name" value="{{ old('full_name', $client->full_name) }}" name="full_name" required>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="validationCustom02" placeholder="Phone Number" value="{{ old('phone_number', $client->phone_number) }}" name="phone_number" required>
        <div class="valid-feedback">
            Looks good!
        </div>
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="email" class="form-control" id="validationCustom03" placeholder="Email" value="{{ old('email', $client->email) }}" name="email" required>
        <div class="valid-feedback">
            Looks good!
        </div>
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="validationCustom04" placeholder="Address" value="{{ old('address', $client->address) }}" name="address" required>
    ...
    <button class="btn btn-primary" type="submit">Update Client</button> <!-- Change button text -->
</form>

                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="sub-header"></p>
                                            ...
                                            <form class="needs-validation" method="POST" action="{{ route('drivers.store') }}" novalidate>
                                                     @csrf 
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom02" placeholder="Phone Number" value="" name="phone_number" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="validationCustom03" placeholder="email" value="" name="email" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
